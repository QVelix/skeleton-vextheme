...
class ProductGetterService {
    ...
    getAccouting() {
        return this.http.get('/apps/generator/assets/cities/altayskiy_kray/accounting.json').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_0__.switchMap)(json => {
            console.log(json);
